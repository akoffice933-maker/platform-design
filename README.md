...
## Фронтенд (v0.1) — рабочий, не макет

`frontend/` — React 18 + Vite + TS + Tailwind (пресет токенов) + recharts. Весь продукт:
симулятор сессий на **живом движке контракта docs/09** (ветвления, критический эпизод,
баллы 8 навыков), разбор с радаром, кабинет клиента с игрой «Дыхание 4-7-8»,
TMA 390×844 с экраном offline (E-53o), верификация с чек-листом, супервизия с
хронологией шагов, стейты E-80…E-85. Данные — мок-API (localStorage).
